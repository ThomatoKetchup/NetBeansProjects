...
// Use a border pane as the root for scene
        BorderPane border = new BorderPane(); // on déclare un border pane
        
        HBox hbox = addHBox();
        border.setTop(hbox); //Il est en haut
        border.setLeft(addVBox()); //il est en bas 
 ...
 */
    private GridPane addGridPane() {
        ...
        ImageView imageHouse = new ImageView(
                    new Image(LayoutSample.class.getResourceAsStream("/resources/picture/house.png")));
        ...
        ImageView imageChart = new ImageView(
                    new Image(LayoutSample.class.getResourceAsStream("/resources/picture/piechart.png")));
    ...
    private FlowPane addFlowPane() {
        ...
        for (int i=0; i<8; i++) {
            pages[i] = new ImageView(
                    new Image(this.getClass().getResourceAsStream("/resources/picture/chart_"+(i+1)+".png")));
    ...
    private TilePane addTilePane() {
        ...
        for (int i=0; i<8; i++) {
            pages[i] = new ImageView(
                    ...
                    "resources/picture/chart_"+(i+1)+".png")));
